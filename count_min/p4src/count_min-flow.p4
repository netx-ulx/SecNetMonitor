...
field_list hash_fields{
	custom_metadata.xor_ips;
	custom_metadata.xor_ports;
...
action update_row(){
	...
	bit_xor(custom_metadata.xor_ips, ipv4.srcAddr, ipv4.dstAddr);
	bit_xor(custom_metadata.xor_ports, tcp.srcPort, tcp.dstPort);
	/*
